...
(function($){
   $.fn.aqLayer = function(options) {
      var opts = $.extend({ 
         attach: 'nw', offsetX: 80, offsetY: -74, 
         show: false, opacity: .96,
         closeBtn: false, closeImg: 'http://tinyurl.com/6ba6nl',
         noClose: false, 
         clone: false,
         layerCss: { 
            zIndex: 2, display: 'none', position: 'absolute',
            background: ' url(http://ezemeet.copops.com/image/Overlay/mid.gif) repeat' },
         topCss: { 
            height: '5px', 
            background: 'transparent url(http://ezemeet.copops.com/image/Overlay/mid.gif)  top left' },
         botCss: { 
            height: '5px', 
            background: 'transparent url(http://ezemeet.copops.com/image/Overlay/bot.gif)  bottom left' },
         midCss: { 
            color: '#222', 

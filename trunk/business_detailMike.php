...
<div id="body_content">
	...
	<br>
	<label style="align:left">Business profile informations :</label>
...
<ul class="gallery_demo_unstyled">
    ...
    <li><img src="image/galleria/4.jpg" alt="Ladybug" title="Menu"></li>
    <li><img src="image/galleria/5.jpg" alt="Lightning" title="Back room"></li>
    <li><img src="image/galleria/6.jpg" alt="Lotus" title="Big Mac ;-)"></li>
    <li><img src="image/galleria/7.jpg" alt="Mojave" title="Spicy prawns and rice"></li>
    <li><img src="image/galleria/8.jpg" alt="Pier" title="Harbour view from our balcony"></li>
    <li><img src="image/galleria/9.jpg" alt="Sea Mist" title="View of the kitchen grill"></li>
